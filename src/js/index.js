...
import ErrorTip from '../components/error-tip/index';
...
const App = ($,win) => {
    const $app = $('#app'),
        ...
        newScrollTopBottom = tools.scrollTopBottom.bind(null,scrollTopBottom);
    ...
    const _handleScrollEvent = (isBind) => {
        isBind ? $window.on('scroll',newScrollTopBottom)
               : $window.off('scroll',newScrollTopBottom);
    }
